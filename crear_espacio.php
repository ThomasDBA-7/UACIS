...
$stmt = $pdo->prepare('INSERT INTO espacios (nombre, tipo, capacidad, ubicacion, descripcion, imagen, estado, creado_por)
                       VALUES (?, ?, ?, ?, ?, ?, "activo", ?)');
$stmt->execute([$nombre, $tipo, $capacidad, $ubicacion, $descripcion, $imagen, $correo]);
